...
import './User.css';
import { ListGroup, ListGroupItem, Button, Row, Col, ButtonGroup, Input, Label } from 'reactstrap';
        ...
        const section = (
            <div className="list-item">
                <Row>
                    ...
                    <Col xs="1"> <Button onClick={e => this.editUser(user)}>Edit</Button></Col>
                    <Col xs="1"> <Button onClick={e => this.deleteUser(user)}>Delete</Button></Col>
                </Row>
            </div>
        );
        return section;
